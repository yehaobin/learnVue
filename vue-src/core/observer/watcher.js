...
export default class Watcher {
  ...
  constructor (
    ...
    // this.getter 对应就是 updateComponent 函数，实际上执行了vm._update(vm._render(), hydrating)
    ...
    // computed watcher 计算属性观察者 this.lazy 值为true
  ...
  update () {
    ...
    if (this.lazy) {
      this.dirty = true // 计算属性依赖收集时会重新计算
    } else if (this.sync) {
      this.run()
    } else {
      queueWatcher(this)
